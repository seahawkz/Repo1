...
$file1 = Get-Content "C:\Users\andedre\Documents\Joe.txt" | Sort-Object -Unique | Get-Unique -AsString
$file2 = Get-Content "C:\Users\andedre\Documents\Derek.txt" | Sort-Object -Unique | Get-Unique -AsString
